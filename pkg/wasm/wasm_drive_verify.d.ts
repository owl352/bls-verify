...
export interface InitOutput {
  ...
  readonly verifyactionsignerstotalpowerresult_root_hash: (a: number) => [number, number];
  ...
  readonly verifyActionSignersTotalPower: (a: any, b: any, c: number, d: number, e: any, f: any, g: number, h: number) => [number, number, number];
  readonly __wbg_verifytokenbalancesforidentityidresult_free: (a: number, b: number) => void;
  readonly verifytokenbalancesforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifytokenbalancesforidentityidresult_balances: (a: number) => any;
  readonly verifyTokenBalancesForIdentityIdVec: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly verifyTokenBalancesForIdentityIdMap: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifytokendirectsellingpricesresult_free: (a: number, b: number) => void;
  readonly verifytokendirectsellingpricesresult_root_hash: (a: number) => [number, number];
  readonly verifytokendirectsellingpricesresult_prices: (a: number) => any;
  readonly verifyTokenDirectSellingPricesVec: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly verifyTokenDirectSellingPricesMap: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifytokeninfosforidentityidresult_free: (a: number, b: number) => void;
  readonly verifytokeninfosforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifytokeninfosforidentityidresult_token_infos: (a: number) => any;
  readonly verifyTokenInfosForIdentityIdVec: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly verifyTokenInfosForIdentityIdMap: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifytokeninfosforidentityidsresult_free: (a: number, b: number) => void;
  readonly verifytokeninfosforidentityidsresult_root_hash: (a: number) => [number, number];
  readonly verifytokeninfosforidentityidsresult_token_infos: (a: number) => any;
  readonly verifyTokenInfosForIdentityIdsVec: (a: any, b: any, c: number, d: any, e: number) => [number, number, number];
  readonly verifyTokenInfosForIdentityIdsMap: (a: any, b: any, c: number, d: any, e: number) => [number, number, number];
  readonly __wbg_verifytokenstatusesresult_free: (a: number, b: number) => void;
  readonly verifytokenstatusesresult_root_hash: (a: number) => [number, number];
  readonly verifytokenstatusesresult_statuses: (a: number) => any;
  readonly verifyTokenStatusesVec: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly verifyTokenStatusesMap: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifytokenstatusresult_free: (a: number, b: number) => void;
  readonly verifytokenstatusresult_root_hash: (a: number) => [number, number];
  readonly verifytokenstatusresult_status: (a: number) => any;
  readonly verifyTokenStatus: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyidentitiescontractkeysresult_free: (a: number, b: number) => void;
  readonly verifyidentitiescontractkeysresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitiescontractkeysresult_keys: (a: number) => any;
  readonly verifyIdentitiesContractKeys: (a: any, b: any, c: any, d: number, e: number, f: any, g: number, h: number) => [number, number, number];
  readonly __wbg_verifyidentitycontractnonceresult_free: (a: number, b: number) => void;
  readonly verifyidentitycontractnonceresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitycontractnonceresult_nonce: (a: number) => [number, bigint];
  readonly verifyIdentityContractNonce: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifystatetransitionwasexecutedwithproofresult_free: (a: number, b: number) => void;
  readonly verifystatetransitionwasexecutedwithproofresult_root_hash: (a: number) => [number, number];
  readonly verifystatetransitionwasexecutedwithproofresult_proof_result: (a: number) => any;
  readonly verifyStateTransitionWasExecutedWithProof: (a: any, b: bigint, c: bigint, d: number, e: any, f: any, g: number) => [number, number, number];
  readonly __wbg_verifytokeninfoforidentityidresult_free: (a: number, b: number) => void;
  readonly verifytokeninfoforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifytokeninfoforidentityidresult_token_info: (a: number) => any;
  readonly verifyTokenInfoForIdentityId: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifydocumentproofresult_free: (a: number, b: number) => void;
  readonly verifydocumentproofresult_root_hash: (a: number) => [number, number];
  readonly verifydocumentproofresult_documents: (a: number) => any;
  readonly verifyDocumentProof: (a: any, b: any, c: number, d: number, e: any, f: any, g: number, h: number, i: number, j: number, k: number, l: bigint, m: number) => [number, number, number];
  readonly __wbg_tokentransitionpathqueryresult_free: (a: number, b: number) => void;
  readonly tokentransitionpathqueryresult_path_query: (a: number) => any;
  readonly tokenTransitionIntoPathQuery: (a: any, b: any, c: any, d: number) => [number, number, number];
  readonly tokenBalanceForIdentityIdQuery: (a: any, b: any) => [number, number, number];
  readonly tokenBalancesForIdentityIdsQuery: (a: any, b: any) => [number, number, number];
  readonly tokenInfoForIdentityIdQuery: (a: any, b: any) => [number, number, number];
  readonly tokenDirectPurchasePriceQuery: (a: any) => [number, number, number];
  readonly groupActiveAndClosedActionSingleSignerQuery: (a: any, b: number, c: any, d: any) => [number, number, number];
  readonly verifyTokenPerpetualDistributionLastPaidTime: (a: any, b: any, c: any, d: any, e: number, f: number) => [number, number, number];
  readonly verifyVotePollVoteStateProof: (a: any, b: any, c: number, d: number, e: number, f: number, g: any, h: number, i: number, j: number, k: number) => [number, number, number];
  readonly __wbg_verifyvotepollvotesproofresult_free: (a: number, b: number) => void;
  readonly verifyvotepollvotesproofresult_root_hash: (a: number) => [number, number];
  readonly verifyvotepollvotesproofresult_votes: (a: number) => any;
  readonly verifyVotePollVotesProof: (a: any, b: any, c: number, d: number, e: number, f: number, g: any, h: any, i: number, j: number, k: number, l: number) => [number, number, number];
  ...
  readonly verifyvotepollvotestateproofresult_result: (a: number) => any;
  readonly verifyvotepollvotestateproofresult_root_hash: (a: number) => [number, number];
  readonly verifytokenperpetualdistributionlastpaidtimeresult_last_paid_time: (a: number) => any;
  readonly verifytokenperpetualdistributionlastpaidtimeresult_root_hash: (a: number) => [number, number];
  readonly __wbg_verifyactionsignersresult_free: (a: number, b: number) => void;
  readonly verifyactionsignersresult_root_hash: (a: number) => [number, number];
  readonly verifyactionsignersresult_signers: (a: number) => any;
  readonly verifyActionSignersVec: (a: any, b: any, c: number, d: number, e: any, f: number, g: number) => [number, number, number];
  readonly verifyActionSignersMap: (a: any, b: any, c: number, d: number, e: any, f: number, g: number) => [number, number, number];
  readonly __wbg_verifyupgradestateresult_free: (a: number, b: number) => void;
  readonly verifyupgradestateresult_root_hash: (a: number) => [number, number];
  readonly verifyupgradestateresult_upgrade_state: (a: number) => any;
  readonly verifyUpgradeState: (a: any, b: number) => [number, number, number];
  readonly __wbg_verifytokenbalanceforidentityidresult_free: (a: number, b: number) => void;
  readonly verifytokenbalanceforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifytokenbalanceforidentityidresult_balance: (a: number) => [number, bigint];
  readonly verifyTokenBalanceForIdentityId: (a: any, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifycontractresult_free: (a: number, b: number) => void;
  readonly verifycontractresult_root_hash: (a: number) => [number, number];
  readonly verifycontractresult_contract: (a: number) => any;
  readonly verifyContract: (a: any, b: number, c: number, d: number, e: any, f: number) => [number, number, number];
  readonly __wbg_verifycontracthistoryresult_free: (a: number, b: number) => void;
  readonly verifycontracthistoryresult_root_hash: (a: number) => [number, number];
  readonly verifycontracthistoryresult_contract_history: (a: number) => any;
  readonly verifyContractHistory: (a: any, b: any, c: bigint, d: number, e: number, f: number) => [number, number, number];
  readonly __wbg_verifyactioninfosincontractresult_free: (a: number, b: number) => void;
  readonly verifyactioninfosincontractresult_root_hash: (a: number) => [number, number];
  readonly verifyactioninfosincontractresult_actions: (a: number) => any;
  readonly verifyActionInfosInContractVec: (a: any, b: any, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly verifyActionInfosInContractMap: (a: any, b: any, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly __wbg_verifygroupinfosincontractresult_free: (a: number, b: number) => void;
  readonly verifygroupinfosincontractresult_root_hash: (a: number) => [number, number];
  readonly verifygroupinfosincontractresult_groups: (a: number) => any;
  readonly verifyGroupInfosInContractVec: (a: any, b: any, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly verifyGroupInfosInContractMap: (a: any, b: any, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly __wbg_verifyidentitybalancesforidentityidsresult_free: (a: number, b: number) => void;
  readonly verifyidentitybalancesforidentityidsresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitybalancesforidentityidsresult_balances: (a: number) => any;
  readonly verifyIdentityBalancesForIdentityIdsVec: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly verifyIdentityBalancesForIdentityIdsMap: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly __wbg_verifyidentitykeysbyidentityidresult_free: (a: number, b: number) => void;
  readonly verifyidentitykeysbyidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitykeysbyidentityidresult_identity: (a: number) => any;
  readonly verifyIdentityKeysByIdentityId: (a: any, b: any, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly __wbg_verifyupgradevotestatusresult_free: (a: number, b: number) => void;
  readonly verifyupgradevotestatusresult_root_hash: (a: number) => [number, number];
  readonly verifyupgradevotestatusresult_vote_status: (a: number) => any;
  readonly verifyUpgradeVoteStatus: (a: any, b: number, c: number, d: number) => [number, number, number];
  readonly __wbg_verifytokenbalancesforidentityidsresult_free: (a: number, b: number) => void;
  readonly verifytokenbalancesforidentityidsresult_root_hash: (a: number) => [number, number];
  readonly verifytokenbalancesforidentityidsresult_balances: (a: number) => any;
  readonly verifyTokenBalancesForIdentityIdsVec: (a: any, b: any, c: number, d: any, e: number) => [number, number, number];
  readonly verifyTokenBalancesForIdentityIdsMap: (a: any, b: any, c: number, d: any, e: number) => [number, number, number];
  readonly __wbg_verifytokenpreprogrammeddistributionsresult_free: (a: number, b: number) => void;
  readonly verifytokenpreprogrammeddistributionsresult_root_hash: (a: number) => [number, number];
  readonly verifytokenpreprogrammeddistributionsresult_distributions: (a: number) => any;
  readonly verifyTokenPreProgrammedDistributionsVec: (a: any, b: any, c: number, d: bigint, e: number, f: number, g: number, h: number) => [number, number, number];
  readonly verifyTokenPreProgrammedDistributionsMap: (a: any, b: any, c: number, d: bigint, e: number, f: number, g: number, h: number) => [number, number, number];
  readonly __wbg_verifytokencontractinforesult_free: (a: number, b: number) => void;
  readonly verifytokencontractinforesult_root_hash: (a: number) => [number, number];
  readonly verifytokencontractinforesult_contract_info: (a: number) => any;
  readonly verifyTokenContractInfo: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyspecializedbalanceresult_free: (a: number, b: number) => void;
  readonly verifyspecializedbalanceresult_root_hash: (a: number) => [number, number];
  readonly verifyspecializedbalanceresult_balance: (a: number) => [number, bigint];
  readonly verifySpecializedBalance: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyfullidentitiesbypublickeyhashesresult_free: (a: number, b: number) => void;
  readonly verifyfullidentitiesbypublickeyhashesresult_root_hash: (a: number) => [number, number];
  readonly verifyfullidentitiesbypublickeyhashesresult_identities: (a: number) => any;
  readonly verifyFullIdentitiesByPublicKeyHashesVec: (a: any, b: any, c: number) => [number, number, number];
  readonly verifyFullIdentitiesByPublicKeyHashesMap: (a: any, b: any, c: number) => [number, number, number];
  readonly __wbg_verifyidentityidsbyuniquepublickeyhashesresult_free: (a: number, b: number) => void;
  readonly verifyidentityidsbyuniquepublickeyhashesresult_root_hash: (a: number) => [number, number];
  readonly verifyidentityidsbyuniquepublickeyhashesresult_identity_ids: (a: number) => any;
  readonly verifyIdentityIdsByUniquePublicKeyHashesVec: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly verifyIdentityIdsByUniquePublicKeyHashesMap: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly __wbg_verifyfullidentitybyidentityidresult_free: (a: number, b: number) => void;
  readonly verifyfullidentitybyidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifyfullidentitybyidentityidresult_identity: (a: number) => any;
  readonly verifyFullIdentityByIdentityId: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly __wbg_verifyidentitynonceresult_free: (a: number, b: number) => void;
  readonly verifyidentitynonceresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitynonceresult_nonce: (a: number) => [number, bigint];
  readonly verifyIdentityNonce: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyepochproposersresult_free: (a: number, b: number) => void;
  readonly verifyepochproposersresult_root_hash: (a: number) => [number, number];
  readonly verifyepochproposersresult_proposers: (a: number) => any;
  readonly verifyEpochProposersByRangeVec: (a: any, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
  readonly verifyEpochProposersByRangeMap: (a: any, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
  readonly verifyEpochProposersByIdsVec: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly verifyEpochProposersByIdsMap: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly __wbg_verifyidentitybalanceforidentityidresult_free: (a: number, b: number) => void;
  readonly verifyidentitybalanceforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitybalanceforidentityidresult_balance: (a: number) => [number, bigint];
  readonly verifyIdentityBalanceForIdentityId: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyidentityidbyuniquepublickeyhashresult_free: (a: number, b: number) => void;
  readonly verifyidentityidbyuniquepublickeyhashresult_root_hash: (a: number) => [number, number];
  readonly verifyidentityidbyuniquepublickeyhashresult_identity_id: (a: number) => [number, number];
  readonly verifyIdentityIdByUniquePublicKeyHash: (a: any, b: number, c: any, d: number) => [number, number, number];
  readonly __wbg_singledocumentdrivequerywasm_free: (a: number, b: number) => void;
  readonly singledocumentdrivequerywasm_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number];
  readonly singledocumentdrivequerywasm_contractId: (a: number) => [number, number];
  readonly singledocumentdrivequerywasm_documentTypeName: (a: number) => [number, number];
  readonly singledocumentdrivequerywasm_documentTypeKeepsHistory: (a: number) => number;
  readonly singledocumentdrivequerywasm_documentId: (a: number) => [number, number];
  readonly singledocumentdrivequerywasm_blockTimeMs: (a: number) => [number, number];
  ...
  readonly singledocumentproofresult_rootHash: (a: number) => [number, number];
  readonly singledocumentproofresult_documentSerialized: (a: number) => [number, number];
  readonly singledocumentproofresult_hasDocument: (a: number) => number;
  readonly verifySingleDocumentProofKeepSerialized: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
  readonly createSingleDocumentQuery: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly createSingleDocumentQueryMaybeContested: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly createSingleDocumentQueryContested: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
  readonly main: () => void;
  readonly __wbg_verifydocumentproofkeepserializedresult_free: (a: number, b: number) => void;
  readonly verifydocumentproofkeepserializedresult_root_hash: (a: number) => [number, number];
  readonly verifydocumentproofkeepserializedresult_serialized_documents: (a: number) => any;
  readonly verifyDocumentProofKeepSerialized: (a: any, b: any, c: number, d: number, e: any, f: any, g: number, h: number, i: number, j: number, k: number, l: bigint, m: number) => [number, number, number];
  readonly __wbg_verifyidentitybalanceandrevisionforidentityidresult_free: (a: number, b: number) => void;
  readonly verifyidentitybalanceandrevisionforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifyidentitybalanceandrevisionforidentityidresult_balance: (a: number) => [number, bigint];
  readonly verifyidentitybalanceandrevisionforidentityidresult_revision: (a: number) => [number, bigint];
  readonly verifyIdentityBalanceAndRevisionForIdentityId: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyidentityidbynonuniquepublickeyhashresult_free: (a: number, b: number) => void;
  readonly verifyidentityidbynonuniquepublickeyhashresult_root_hash: (a: number) => [number, number];
  readonly verifyidentityidbynonuniquepublickeyhashresult_identity_id: (a: number) => [number, number];
  readonly verifyIdentityIdByNonUniquePublicKeyHash: (a: any, b: number, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifyelementsresult_free: (a: number, b: number) => void;
  readonly verifyelementsresult_root_hash: (a: number) => [number, number];
  readonly verifyelementsresult_elements: (a: number) => any;
  readonly verifyElements: (a: any, b: any, c: any, d: number) => [number, number, number];
  readonly __wbg_verifyepochinfosresult_free: (a: number, b: number) => void;
  readonly verifyepochinfosresult_root_hash: (a: number) => [number, number];
  readonly verifyepochinfosresult_epoch_infos: (a: number) => any;
  readonly verifyEpochInfos: (a: any, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
  readonly __wbg_verifytokentotalsupplyandaggregatedidentitybalanceresult_free: (a: number, b: number) => void;
  readonly verifytokentotalsupplyandaggregatedidentitybalanceresult_root_hash: (a: number) => [number, number];
  readonly verifytokentotalsupplyandaggregatedidentitybalanceresult_total_supply_and_balance: (a: number) => any;
  readonly verifyTokenTotalSupplyAndAggregatedIdentityBalance: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifyidentityvotesgivenproofresult_free: (a: number, b: number) => void;
  readonly verifyidentityvotesgivenproofresult_root_hash: (a: number) => [number, number];
  readonly verifyidentityvotesgivenproofresult_votes: (a: number) => any;
  readonly verifyIdentityVotesGivenProofVec: (a: any, b: any, c: any, d: number) => [number, number, number];
  readonly verifyIdentityVotesGivenProofMap: (a: any, b: any, c: any, d: number) => [number, number, number];
  readonly __wbg_verifymasternodevoteresult_free: (a: number, b: number) => void;
  readonly verifymasternodevoteresult_root_hash: (a: number) => [number, number];
  readonly verifymasternodevoteresult_vote: (a: number) => [number, number];
  readonly verifyMasternodeVote: (a: any, b: any, c: any, d: any, e: number, f: number) => [number, number, number];
  readonly __wbg_verifystartatdocumentinproofresult_free: (a: number, b: number) => void;
  readonly verifystartatdocumentinproofresult_root_hash: (a: number) => [number, number];
  readonly verifystartatdocumentinproofresult_document: (a: number) => any;
  readonly verifyStartAtDocumentInProof: (a: any, b: any, c: number, d: number, e: any, f: any, g: number, h: number, i: number, j: number, k: number, l: bigint, m: number, n: any, o: number) => [number, number, number];
  readonly __wbg_verifyidentityrevisionforidentityidresult_free: (a: number, b: number) => void;
  readonly verifyidentityrevisionforidentityidresult_root_hash: (a: number) => [number, number];
  readonly verifyidentityrevisionforidentityidresult_revision: (a: number) => [number, bigint];
  readonly verifyIdentityRevisionForIdentityId: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifytokendirectsellingpriceresult_free: (a: number, b: number) => void;
  readonly verifytokendirectsellingpriceresult_root_hash: (a: number) => [number, number];
  readonly verifytokendirectsellingpriceresult_price: (a: number) => any;
  readonly verifyTokenDirectSellingPrice: (a: any, b: any, c: number, d: number) => [number, number, number];
  readonly __wbg_verifycontestsproofresult_free: (a: number, b: number) => void;
  readonly verifycontestsproofresult_root_hash: (a: number) => [number, number];
  readonly verifycontestsproofresult_contests: (a: number) => any;
  readonly verifyContestsProof: (a: any, b: any, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number, number];
  readonly __wbg_verifygroupinforesult_free: (a: number, b: number) => void;
  readonly verifygroupinforesult_root_hash: (a: number) => [number, number];
  readonly verifygroupinforesult_group: (a: number) => any;
  readonly verifyGroupInfo: (a: any, b: any, c: number, d: number, e: number) => [number, number, number];
  readonly __wbg_verifyfullidentitybynonuniquepublickeyhashresult_free: (a: number, b: number) => void;
  readonly verifyfullidentitybynonuniquepublickeyhashresult_root_hash: (a: number) => [number, number];
  readonly verifyfullidentitybynonuniquepublickeyhashresult_identity: (a: number) => any;
  readonly verifyFullIdentityByNonUniquePublicKeyHash: (a: number, b: any, c: any, d: number, e: number) => [number, number, number];
  readonly __wbg_verifyfullidentitybyuniquepublickeyhashresult_free: (a: number, b: number) => void;
  readonly verifyfullidentitybyuniquepublickeyhashresult_root_hash: (a: number) => [number, number];
  readonly verifyfullidentitybyuniquepublickeyhashresult_identity: (a: number) => any;
  readonly verifyFullIdentityByUniquePublicKeyHash: (a: any, b: any, c: number) => [number, number, number];
  readonly __wbg_verifytotalcreditsinsystemresult_free: (a: number, b: number) => void;
  readonly verifytotalcreditsinsystemresult_root_hash: (a: number) => [number, number];
  readonly verifytotalcreditsinsystemresult_total_credits: (a: number) => bigint;
  readonly verifyTotalCreditsInSystem: (a: any, b: number, c: number, d: number, e: number) => [number, number, number];
  readonly __wbg_verifyvotepollsenddatequeryresult_free: (a: number, b: number) => void;
  readonly verifyvotepollsenddatequeryresult_root_hash: (a: number) => [number, number];
  readonly verifyvotepollsenddatequeryresult_vote_polls: (a: number) => any;
  readonly verifyVotePollsEndDateQueryVec: (a: any, b: any, c: number) => [number, number, number];
  readonly verifyVotePollsEndDateQueryMap: (a: any, b: any, c: number) => [number, number, number];
  ...
  readonly closure1861_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure5920_externref_shim: (a: number, b: number, c: any, d: any) => void;
